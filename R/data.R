...
#' @docType package
#' @name portaldatar
#' @aliases portaldatar portaldata-package
NULL
...
#' @format A data frame with 10 columns and 54 rows, The names of the columns are: "label","species_id","genus","species","taxa","ott_name","approximate_match","ott_id","is_synonym", and "flags"
"taxonomy"
